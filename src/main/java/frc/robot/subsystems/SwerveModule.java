...
public class SwerveModule extends SubsystemBase {
	...
	public SwerveModule(CANBus canbus, int driveID, int steerID, int cancoderID, double magnetOffset) {
	  this.canbus = canbus;
	  ...
	  drive = new Kraken(driveID, canbus);
	  steer = new Kraken(steerID, canbus);
